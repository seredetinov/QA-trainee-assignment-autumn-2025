...
public class GetStatisticByIdTest {
    ...
    class PositiveTest{
        ...
        @Test
        @DisplayName("№05 | Получение статистики существующего объявления")
        ...
        @Test
        @DisplayName("№06 | Идемпотентность метода GET при повторном получении статистики объявления")
    ...
    class NegativeTest{
        @Test
        @DisplayName("№07 | Получение статистики объявления без указания идентификатора")
        public void getStatisticByIdNoIdTest(){
            sendRequestValidateResponse(endpoint, null,GET,404, null);
        }

        @Test
        @DisplayName("№08 | Получение статистики объявления по недопустимому значению идентификатора")
